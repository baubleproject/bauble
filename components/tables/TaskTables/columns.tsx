...
export const columns: ColumnDef<TasksandAssignedTo>[] = [
...

    {
        ...
        cell: ({ row }) => {
            ...
            const onTaskDelete = async (data: z.infer<typeof FormSchema>) => {
                try {
                    await axios.put(`/api/tasks/${task.id}/edit`, data);
                    toast.success("task status has been updated");
                    router.refresh();
            ...
            return (
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem className="bg-red-300 dark:bg-red-800" onClick={() => onTaskDelete} >Delete Task (admin only)</DropdownMenuItem>
                    </DropdownMenuContent>
                </DropdownMenu>
            );
        },
