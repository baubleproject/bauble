...
export default function TopBar() {
    ...
    return (
        <nav className='w-full h-16 p-1 bg-white border-b-[0.1px] border-zinc-100 dark:border-zinc-800 dark:bg-black flex items-center justify-end space-x-4 px-3 py-2'>
