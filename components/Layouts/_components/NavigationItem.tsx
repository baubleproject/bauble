...
export default function NavigationItem({ link, classname }: Props) {
    ...
    return (
        <div onClick={routeToProfile} className={cn(`py-2 justify-center items-center dark:hover:bg-zinc-800 hover:bg-zinc-400 transition-colors duration-300 rounded-md cursor-pointer ${isCollapsed ? ("w-5/6 flex") : ("w-full px-2 grid grid-cols-6")}`, classname)}>
